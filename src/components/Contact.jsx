...
const Contact = () => {
    return (
        <div
            ...
            style={{backgroundImage: "url('https://images.pexels.com/photos/29602431/pexels-photo-29602431/free-photo-of-cozy-workspace-with-coffee-and-tablet-in-istanbul-cafe.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+91 4623 154 789</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2" />
                            <span className="text-gray-600">companyofficial@gmail.com</span>
                        </div>
